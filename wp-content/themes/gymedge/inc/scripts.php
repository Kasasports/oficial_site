...
if ( !function_exists( 'gymedge_register_scripts' ) ) {
	function gymedge_register_scripts(){
		...
		// magnific popup
		wp_register_style( 'magnific-popup',     GymEdge_Helper::maybe_rtl( 'magnific-popup.min.css' ), array(), GYMEDGE_THEME_VERSION );
...
if ( !function_exists( 'gymedge_enqueue_scripts' ) ) {
	function gymedge_enqueue_scripts() {
		...
		// Bootstrap CSS
		wp_enqueue_style( 'bootstrap',            GymEdge_Helper::maybe_rtl( 'bootstrap.min.css' ), array(), GYMEDGE_THEME_VERSION );
		// font-awesome CSS
		wp_enqueue_style( 'font-awesome',         GYMEDGE_CSS_URL . 'font-awesome.min.css', array(), GYMEDGE_THEME_VERSION );
		// Meanmenu CSS
		wp_enqueue_style( 'meanmenu',             GymEdge_Helper::maybe_rtl( 'meanmenu.css' ), array(), GYMEDGE_THEME_VERSION );
		// main CSS
		wp_enqueue_style( 'gymedge-default',      GymEdge_Helper::maybe_rtl( 'default.css' ), array(), GYMEDGE_THEME_VERSION );
		// vc modules css
		wp_enqueue_style( 'gymedge-vc',           GymEdge_Helper::maybe_rtl( 'vc.css' ), array(), GYMEDGE_THEME_VERSION );
		// style CSS
		wp_enqueue_style( 'gymedge-style',        GymEdge_Helper::maybe_rtl( 'style.css' ), array(), GYMEDGE_THEME_VERSION );
		// responsive CSS
		wp_enqueue_style( 'gymedge-responsive',   GymEdge_Helper::maybe_rtl( 'responsive.css' ), array(), GYMEDGE_THEME_VERSION );
		// variable style CSS
		ob_start();
...
if ( !function_exists( 'gymedge_admin_scripts' ) ) {
	function gymedge_admin_scripts(){
		...
		wp_enqueue_style( 'gymedge-admin', GymEdge_Helper::maybe_rtl( 'admin.css' ), array(), GYMEDGE_THEME_VERSION );
