...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(
		...
		array(
			'id'       => 'preloader_image',
			'type'     => 'media',
			'title'    => __( 'Preloader Image', 'gymedge' ),
			'subtitle' => __( 'Please upload your choice of preloader image. Transparent GIF format is recommended', 'gymedge' ),
			'default'  => array(
...
Redux::setSection( $opt_name, array(
	'title' => __( 'Contact & Socials', 'gymedge' ),
	'id' => 'socials_section',
	'heading' => '',
...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(
		array(
			...
			'options' => array(
				'style1' => __( 'Style 1', 'gymedge' ),
				'style2' => __( 'Style 2', 'gymedge' ) 
			),
			'default' => 'style1' 
		),
		array(
		...
		array(
			'id' => 'footer2_bgtype',
			'type' => 'button_set',
			'title' => __( 'Footer Background Type', 'gymedge' ),
			'options' => array(
		...
		array(
			'id' => 'footer2_bgimg',
			'type' => 'media',
			'title' => __( 'Background Image', 'gymedge' ),
			'required' => array(
				'footer2_bgtype',
				'equals',
				'bgimg' 
