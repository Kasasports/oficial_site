...
function gymedge_core_vc_modules(){
	...
	$modules = array( 'inc/abstruct', 'title', 'post-slider', 'post-list', 'post-grid', 'bmi-calculator', 'trainer', 'class', 'class-upcoming', 'schedule', 'routine', 'testimonial', 'info-text', 'intro', 'about', 'pricing-box', 'button', 'counter', 'experience', 'skill', 'gallery', 'cta', 'cta-signup', 'cta-discount', 'about-fitness' );
